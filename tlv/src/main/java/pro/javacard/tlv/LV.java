...
// Length-value (no tag) sequences. Lengths are emitted as canonical BER via Len (128 -> 81 80) but
// parsed tolerantly: a single byte 0x00..0x80 is the length itself, the GlobalPlatform legacy shorthand.
public final class LV {
    ...
    // One length: a byte 0x00..0x80 is the length itself, 0x81/0x82/0x83 introduce that many bytes.
