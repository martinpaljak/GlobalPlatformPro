...
public class GPJTool {
	                ...
	                if (listApplets) {
	                    ...
	                    for (AIDRegistryEntry e : registry) {
	                        ...
	                        System.out.print("AID: "
	                                + GPUtils.byteArrayToString(aid.getBytes())
	                                + spaces
	                                + " "
	                                + GPUtils.byteArrayToReadableString(aid
	                                        .getBytes()) + spaces2);
	...
	public static void usage() {
	    ...
	    System.out.println(" -loadsize <num>   load block size, default "
	            + GlobalPlatform.defaultLoadSize);
	    System.out
